...
const NavBar = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      if (smokeFilter) setSmokeFilter(false);
    }, 500);
  }, [smokeFilter]);
    ...
    <>
      <Box>
        {!smokeFilter ? (
          <Box
            sx={ballonBox}
            className={activePage === "Contact" ? "ballonBoxHom" : "none"}
          >
            <Box className="ballon-big-box"></Box>
          </Box>
        ) : null}
        ...
        <LayoutBox>
              ...
              <Stack spacing={2}>
                <Box sx={NaveBoxInner}>
                  ...
                  >
                    <Box
                      sx={AvatarBox}
                      className={smokeFilter ? "nave-items" : "fadein iconTest"}
                    >
                      <Avatar
                  ...
                  >
                    ...
                    >
                      <Avatar
                        ...
                        className={smokeFilter ? "filter" : "nav-avatar"}
                      >
                        <DeveloperModeIcon className="nav-icon" />
                      </Avatar>
          ...
          <Box sx={bodyBoxStyle}>
            ...
            {smokeFilter
              ? null
              : activePage === "Skills" && <TagCloudComponent />}
